...
//settings page list right hight light <span>       @MUBIN 
...
let cms = {
    ...
    'desktop': [
        ...
        `<a onmousedown="window.open('https://github.com/themubiin/Win12/','_blank');" win12_title="https://github.com/themubiin/Win12/" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)"><i class="bi bi-github"></i> View this project in Github</a>`,
        function (arg) {
            if (edit_mode) {
        ...
        ['<i class="bi bi-info-circle"></i> About Windows 12 ', `$('#win-about>.about').addClass('show');$('#win-about>.update').removeClass('show');openapp('about');if($('.window.about').hasClass('min'))minwin('about');`],
    ...
    'winx': [
        ...
        '<hr>',
        ['<i class="bi bi-gear"></i> Settings', `openapp('setting')`],
...
let nts = {
    'about': {
        cnt: `<p class="tit">Windows 12 experience</p>
    ...
    'feedback': {
        cnt: `<p class="tit">Feedback</p>
            ...
            <list class="new">
                <a class="a" onclick="window.open('https://facebook.com/the.mubiin','_blank');" win12_title="Open link in new browser window" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">Connect on Facebook</a>
                <a class="a" onclick="window.open('https://www.linkedin.com/in/mubiiin/','_blank');" win12_title="Open link in new browser window" onmouseenter="showdescp(event)" onmouseleave="hidedescp(event)">Connect on Linkedin</a>
            </list>`,
        btn: [
            { type: 'main', text: 'Close', js: 'closenotice();' },
        ]
    ...
    'feedback-copilot': {
        ...
        <list class="new">
            <a class="a" onclick="window.open('https://github.com/themubiin/Win12/issues','_blank');" win12_title="Open link in new browser window" onmouseenter ="showdescp(event)" onmouseleave="hidedescp(event)">Submit an issue on github (a github account is required and will receive higher attention)</a>
        ...
        path: {
            folder: {
                            ...
                            folder: {
                                    ...
                                    folder: {
                                        'Document': {
                                            ...
                                            file: [
                                                ...
                                                { name: 'Bangladesh.png', ico: 'icon/files/bd.png', command: '' },
                                ...
                                'Public': {
                                    folder: {
                                        ...
                                        'Downloads': {
                                            folder: { 'Local': { folder: {}, file: [] }, 'Images': { folder: {}, file: [] } },
                                            file: [
                                                 { name: 'Bangladesh.jpg', ico: 'icon/files/bd.png', command: '' },
                                            ]
                                        }
                                    }}}}},
                    file: []
                ...
                'D:': {
                    ...
                    file: [
                        { name: 'WebDextro.docx', ico: 'icon/files/word.png', command: '' },
                        { name: 'Bangladesh.pptx', ico: 'icon/files/ppt.png', command: '' },
                    ]}}},
            ...
            if (le > 0) {
                ...
                $('#search-win>.ans>.list>list').html(
					...
					setTimeout(() => {
						...
						<img src="icon/setting.svg"><p>Settings/p></a>
					<a onclick="openapp('about');$('#search-btn').removeClass('show');
					$('#search-win').removeClass('show');
					setTimeout(() => {
						$('#search-win').removeClass('show-begin');
					}, 200);">
						<img src="icon/about.svg"><p>About Windows 12 experience</p></a>`);
...
let copilot = {
    ...
    init: () => {
        ...
        1. Windows 12 experience is an open source project, originally created by Muntasir Mubin, which uses Html, css, and js to simulate and innovate operating systems on the Internet.
    ...
    send: (t, showusr = true) => {
        ...
        if (t.length == 0) {
            $('#copilot>.chat').append(`<div class="line system"><p class="text">The system said please send something meaningful</p></div>`);
            $('#copilot>.chat').scrollTop($('#copilot>.chat')[0].scrollHeight);
            ...
            if (r.length) {
                for (const i of r) {
                    if (/{openapp .+?}/.test(i)) {
                        ...
                        shownotice('feedback');
                        rt = rt.replace(i, `<div class="action"><p class="tit">Feedback</p><p class="detail">About Windows 12 experience</p></div>`)
